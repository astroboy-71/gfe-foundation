...
function ICOCard() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="auth relative w-full overflow-hidden rounded-lg bg-background bg-opacity-75 pb-[32px] font-mont shadow-lg backdrop-blur-3xl">
        ...
        <div className="px-[32px] pt-[20px]">
          ...
          <div className="mt-2 flex flex-col items-center justify-center gap-[5px]">
            <p className=" text-muted-foreground font-goldman">
              Minted GFE Tokens:{" "}
              <span>
